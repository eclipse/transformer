...
public class TestRegexpTransformPropertiesFile extends CaptureTest {
	...
	public SelectionRule createSelectionRule(CaptureLoggerImpl useLogger, Map<String, String> useIncludes,
											 Map<String, String> useExcludes) {

		return new SelectionRuleImpl(useLogger, useIncludes, useExcludes);
	}

	public SignatureRule createSignatureRule(CaptureLoggerImpl useLogger, Map<String, String> packageRename, Map<String, String> directStrings) {

		return new RegexpSignatureRuleImpl(useLogger, packageRename, null, null, null, null, directStrings, Collections.emptyMap());
	}

	public static final String	JAKARTA_SERVLET	= "jakarta$1";
